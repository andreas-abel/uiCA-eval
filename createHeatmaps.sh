...
createHeatmap icl '4 -analyticalUnroll -arch ICL' 'heatmaps/hm_icl_unroll_analytical.pgf' 'Analytical'
...
echo "~\begin{subfigure}[t]{0.33\textwidth}\resizebox{\textwidth}{!}{\import{heatmaps}{hm_icl_unroll_analytical.pgf}}\end{subfigure}"
...
createHeatmapLoop icl '8 -analyticalLoop -arch ICL' 'heatmaps/hm_icl_loop_analytical.pgf' 'Analytical'
...
echo "~\begin{subfigure}[t]{0.33\textwidth}\resizebox{\textwidth}{!}{\import{heatmaps}{hm_icl_loop_analytical.pgf}}\end{subfigure}"
...
createHeatmap skl '11 -analyticalUnroll -arch SKL' 'heatmaps/hm_skl_unroll_analytical.pgf' 'Analytical'
...
echo "~\begin{subfigure}[t]{0.33\textwidth}\resizebox{\textwidth}{!}{\import{heatmaps}{hm_skl_unroll_analytical.pgf}}\end{subfigure}"
...
createHeatmapLoop skl '14 -analyticalLoop -arch SKL' 'heatmaps/hm_skl_loop_analytical.pgf' 'Analytical'
...
echo "\par\bigskip\begin{subfigure}[t]{0.33\textwidth}\resizebox{\textwidth}{!}{\import{heatmaps}{hm_skl_loop_analytical.pgf}}\end{subfigure}"
...
createHeatmap hsw '11 -analyticalUnroll -arch HSW' 'heatmaps/hm_hsw_unroll_analytical.pgf' 'Analytical'
...
echo "~\begin{subfigure}[t]{0.33\textwidth}\resizebox{\textwidth}{!}{\import{heatmaps}{hm_hsw_unroll_analytical.pgf}}\end{subfigure}"
...
createHeatmapLoop hsw '14 -analyticalLoop -arch HSW' 'heatmaps/hm_hsw_loop_analytical.pgf' 'Analytical'
...
echo "\par\bigskip\begin{subfigure}[t]{0.33\textwidth}\resizebox{\textwidth}{!}{\import{heatmaps}{hm_hsw_loop_analytical.pgf}}\end{subfigure}"
...
createHeatmap ivb '10 -analyticalUnroll -arch IVB' 'heatmaps/hm_ivb_unroll_analytical.pgf' 'Analytical'
...
echo "~\begin{subfigure}[t]{0.33\textwidth}\resizebox{\textwidth}{!}{\import{heatmaps}{hm_ivb_unroll_analytical.pgf}}\end{subfigure}"
...
createHeatmapLoop ivb '13 -analyticalLoop -arch IVB' 'heatmaps/hm_ivb_loop_analytical.pgf' 'Analytical'
...
echo "~\begin{subfigure}[t]{0.33\textwidth}\resizebox{\textwidth}{!}{\import{heatmaps}{hm_ivb_loop_analytical.pgf}}\end{subfigure}"

...
echo "\midrule"
echo "\multirow{2}{*}{RKL}  & \uiCA & `getEntries rkl '2 3'` & `getEntriesLoop rkl '6 7'` \\\\"
echo "                      & CQA ${cqaVersion} & & & `getEntriesLoop rkl '6 5'` \\\\"
echo "                      & Baseline & `getEntries rkl '2 -baselineUnroll -memWritePorts 2'` & `getEntriesLoop rkl '6 -baselineLoop -issueWidth 5 -memWritePorts 2'`\\\\"
[[ "$arg1" == "analytical" ]] && echo "                      & Analytical & `getEntries rkl '2 -analyticalUnroll -arch RKL'` & `getEntriesLoop rkl '6 -analyticalLoop -arch RKL'`\\\\"
echo "\midrule"
